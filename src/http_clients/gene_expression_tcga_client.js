...
const get_gene_expression_tcga_stats = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        https(gene_expression_url.href, options, function (error, response, body) {
            console.info(`[get_gene_expression_tcga_stats] url: ${gene_expression_url.href}, `
...
module.exports = { get_gene_expression_tcga_stats };
